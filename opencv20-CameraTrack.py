...
cv2.createTrackbar('hueLower', 'Trackbars', 130, 179, nothing)
cv2.createTrackbar('hueUpper', 'Trackbars', 130, 179, nothing)

cv2.createTrackbar('hue2Lower', 'Trackbars', 100, 179, nothing)
cv2.createTrackbar('hue2Upper', 'Trackbars', 165, 179, nothing)

cv2.createTrackbar('satLow', 'Trackbars', 220, 255, nothing)
cv2.createTrackbar('satHigh', 'Trackbars', 255, 255, nothing)
cv2.createTrackbar('valLow', 'Trackbars', 100, 255, nothing)
cv2.createTrackbar('valHigh', 'Trackbars', 255, 255, nothing)
